{!! view_render_event('bagisto.shop.components.layouts.header.desktop.bottomwithoutprofile.before') !!}
...
<div class="flex min-h-[78px] w-full justify-between border border-b border-l-0 border-r-0 border-t-0 px-[60px] max-1180:px-8">
    ...
    <div class="flex items-center gap-x-10 max-[1180px]:gap-x-5">
        {!! view_render_event('bagisto.shop.components.layouts.header.desktop.bottomwithoutprofile.logo.before') !!}
        ...
        {!! view_render_event('bagisto.shop.components.layouts.header.desktop.bottomwithoutprofile.logo.after') !!}

        {!! view_render_event('bagisto.shop.components.layouts.header.desktop.bottomwithoutprofile.category.before') !!}
        ...
        {!! view_render_event('bagisto.shop.components.layouts.header.desktop.bottomwithoutprofile.category.after') !!}
    </div>

    <!-- Right Nagivation Section -->
    <div class="flex items-center gap-x-9 max-[1100px]:gap-x-6 max-lg:gap-x-8">

        {!! view_render_event('bagisto.shop.components.layouts.header.desktop.bottomwithoutprofile.search_bar.before') !!}
        ...
        <div class="relative w-full">
            ...
            >
                <label
                    ...
                    class="sr-only"
                >
                    @lang('shop::app.components.layouts.header.desktop.bottomwithoutprofile.search')
                </label>
        ...
        {!! view_render_event('bagisto.shop.components.layouts.header.desktop.bottomwithoutprofile.search_bar.after') !!}

        <!-- Right Navigation Links -->
        <div class="mt-1.5 flex gap-x-8 max-[1100px]:gap-x-6 max-lg:gap-x-8">

            {!! view_render_event('bagisto.shop.components.layouts.header.desktop.bottomwithoutprofile.compare.before') !!}
            ...
            {!! view_render_event('bagisto.shop.components.layouts.header.desktop.bottomwithoutprofile.compare.after') !!}

            {!! view_render_event('bagisto.shop.components.layouts.header.desktop.bottomwithoutprofile.mini_cart.before') !!}
            ...
            {!! view_render_event('bagisto.shop.components.layouts.header.desktop.bottomwithoutprofile.mini_cart.after') !!}

            {!! view_render_event('bagisto.shop.components.layouts.header.desktop.bottomwithoutprofile.profile.before') !!}

            {!! view_render_event('bagisto.shop.components.layouts.header.desktop.bottomwithoutprofile.profile.after') !!}
        </div>
    </div>
</div>
...
@endPushOnce
{!! view_render_event('bagisto.shop.components.layouts.header.desktop.bottomwithoutprofile.after') !!}
