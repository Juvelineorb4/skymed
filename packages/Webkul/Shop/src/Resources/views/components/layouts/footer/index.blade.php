...
<footer class="mt-9 bg-lightOrange max-sm:mt-10 footer-custom">
    <div
    ...
    <div class="flex justify-between bg-[#F1EADF] px-[60px] py-3.5 max-md:justify-center max-sm:px-5 footer-copyright">
